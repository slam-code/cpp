...
int main()
{
    std::cout<< sizeof(unsigned int)<<"-0-"<<std::endl;
    B b;
    std::cout << "-1-\n";
...
/**
如上代码，将对象地址强制转换为指针地址，得到vftable的地址，其中除了vfptr_a，
其余对象的虚函数表的地址是一样的，说明这些对象共用了一个虚函数表。
